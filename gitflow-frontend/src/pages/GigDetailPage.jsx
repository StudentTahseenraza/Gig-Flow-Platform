...
Looking forward to working with you!`}
            ...
            {/* Premium User Badge */}
{gig.premiumBoost && (
  <div className="mb-4 p-3 rounded-lg bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30">
    <div className="flex items-center gap-2">
      <Crown className="w-5 h-5 text-yellow-500" />
      <span className="text-yellow-400 font-medium">Premium Boost Active</span>
      <span className="ml-auto text-sm text-gray-400">10x visibility</span>
    </div>
  </div>
)}
          </div>
